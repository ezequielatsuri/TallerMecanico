        ...
        <form action="{{ route('users.update',['user' => $user]) }}" method="post">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $user->name) }}" required pattern="[A-Za-z\s]+" title="Solo se permiten letras y espacios.">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-4">
                        <input type="password" name="password" id="password" class="form-control" minlength="8" pattern="(?=.*[0-9])(?=.*[A-Za-z]).{8,}" title="La contraseña debe tener al menos 8 caracteres, incluyendo letras y números.">
                    ...
                    <div class="col-lg-4">
                        <select name="role" id="role" class="form-select" required>
                            ...
                            @foreach ($roles as $item)
                                <option value="{{ $item->name }}" @selected(old('role', $user->roles->pluck('name')->contains($item->name)))>{{ $item->name }}</option>
                            @endforeach
                        </select>
