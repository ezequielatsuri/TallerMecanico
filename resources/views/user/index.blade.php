                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-around">
                                <!-- Editar usuario -->
                                @can('editar-user')
                                <a href="{{ route('users.edit', ['user' => $item]) }}" title="Editar" class="btn btn-datatable btn-icon btn-transparent-dark me-2">
                                    <svg class="svg-inline--fa fa-edit" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="edit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                        <path fill="currentColor" d="M402.3 32.5c-12.5-12.5-32.8-12.5-45.3 0l-25.1 25.1 45.3 45.3 25.1-25.1c12.5-12.5 12.5-32.8 0-45.3zM0 512l68.7-68.7L501.6 39.5c12.5-12.5 32.8-12.5 45.3 0l25.1 25.1c12.5 12.5 12.5 32.8 0 45.3L86.7 512H0v-0.1z"></path>
                                    </svg>
                                </a>
                                @endcan
