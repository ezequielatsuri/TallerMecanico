                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                <a title="Editar categoría" class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="{{ route('categorias.edit', ['categoria' => $categoria]) }}">
                                ...
                                <div>
                                    ...
                                    @else
                                    <button title="Restaurar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$categoria->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
