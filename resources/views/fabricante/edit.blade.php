            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-7">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" class="form-control" maxlength="200" oninput="validarDescripcion(this)">{{ old('descripcion', $fabricante->caracteristica->descripcion) }}</textarea>
                        @error('descripcion')
                        <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
