            ...
            <div class="card-body">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" value="{{old('nombre',$fabricante->caracteristica->nombre)}}">
                        @error('nombre')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" class="form-control">{{old('descripcion',$fabricante->caracteristica->descripcion)}}</textarea>
                        @error('descripcion')
                        <small class="text-danger">{{'*'.$message}}</small>
                        @enderror
                    </div>
