                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                <a title="Editar fabricante" class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="{{ route('fabricantes.edit', ['fabricante' => $item]) }}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('fabricantes.destroy',['fabricante'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
